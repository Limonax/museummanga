...
class ArtistsTest < ApplicationSystemTestCase
  ...
  test "creating a Artist" do
    ...
    fill_in "Author", with: @artist.author
    fill_in "Date", with: @artist.date
    fill_in "Description", with: @artist.description
    fill_in "Formatt", with: @artist.formatt
    fill_in "Picture", with: @artist.picture
    fill_in "Title", with: @artist.title
